...
void additional_student_tests() {
  ...
  // =======================================================================
  /*
  std::cout << "Interesting test case, in which two big blocks would be cancled out by one vertical bar\n";
  
  Tetris tetris(16);
  tetris.add_piece('J',0,2);
  tetris.add_piece('S',0,0);
  tetris.add_piece('L',90,0);
  tetris.add_piece('I',90,0);
  tetris.add_piece('L',0,5);
  tetris.add_piece('Z',0,6);
  tetris.add_piece('T',90,7);
  tetris.add_piece('T',0,5);
  tetris.add_piece('O',270,9);
  tetris.add_piece('L',180,10);
  tetris.add_piece('L',90,9);
  tetris.add_piece('J',0,14);
  tetris.add_piece('S',180,12);
  tetris.add_piece('T',270,12);
  tetris.add_piece('T',0,13);
  
  std::cout << "Before inserting a vertical bar:\n"; 
  tetris.print();
  
  tetris.add_piece('I',180,4);
  std::cout << "After inserting a vertical bar, all pieced should be removed and score should be 4.\n";
  std::cout << "Before removing:\n";
  tetris.print();
  assert(tetris.remove_full_rows() == 4);
  ...
  */
  ...
  srand (time(NULL));
  for (int i = 0; i < 10; ++i) {
	  char shape = pieces[rand() % 7];
	  int rotation = angles[rand() % 4];
	  int position = rand() % 10;
	  tetris1.add_piece(shape, rotation, position);
  }
  
  std::cout << "Another interesting case in which 10 random pieces fall from random valid positions to the board\n";
  std::cout << "Please check to see if all the pieces are correctly shaped\n";
  tetris1.print();
  
  assert(tetris1.count_squares() == 40);
  tetris1.destroy();
  // =======================================================================
